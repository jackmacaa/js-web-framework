...
class User {
    ...
    save() {
        ...
        if (id) (0, _axiosDefault.default).put(`${domain}/users/${id}`, this.data);
        else (0, _axiosDefault.default).post(`${domain}/users/${id}`, this.data);
    }
}
...
var Buffer = require("a197822a08b48b99").Buffer;
"use strict";
/**
...
},{"a197822a08b48b99":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../env/classes/FormData.js":"lSnyf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("ad87c46055f1e798");
var ieee754 = require("709ccfcbb6efca71");
...
},{"ad87c46055f1e798":"eIiSV","709ccfcbb6efca71":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3LmCz","h7u1C"], "h7u1C", "parcelRequirea188")
